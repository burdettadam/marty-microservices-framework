...
try:
    ...
    from framework.integration.external_connectors.base import ExternalSystemConnector
    from framework.integration.external_connectors.config import ExternalSystemConfig
    from framework.integration.external_connectors.enums import ConnectorType
