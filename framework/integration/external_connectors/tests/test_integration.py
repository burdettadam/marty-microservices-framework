...
class TestExternalConnectorsStructure(unittest.TestCase):
    ...
    def test_enum_imports(self):
        ...
        try:
            from framework.integration.external_connectors.enums import (
                ConnectorType,
                DataFormat,
                IntegrationPattern,
                TransformationType,
    ...
    def test_config_dataclasses(self):
        ...
        try:
            from framework.integration.external_connectors.config import (
                DataTransformation,
    ...
    def test_base_connector(self):
        ...
        try:
            from framework.integration.external_connectors.base import (
    ...
    def test_transformation_engine(self):
        ...
        try:
            from framework.integration.external_connectors.transformation import (
    ...
    def test_rest_api_connector(self):
        ...
        try:
            from framework.integration.external_connectors.connectors.rest_api import (
                RESTAPIConnector,
            )
