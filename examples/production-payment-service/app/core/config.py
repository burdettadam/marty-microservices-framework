"""
Configuration management for ProductionPaymentService Service
...
class ProductionPaymentServiceConfig(BaseSettings):
    """
    Configuration class for ProductionPaymentService Service.
    ...
    service_name: str = Field(default="production-payment-service", description="Service name")
    ...
    metrics_port: int = Field(default=8002, description="Metrics endpoint port")
    ...
    class Config:
        ...
        env_prefix = "PRODUCTION_PAYMENT_SERVICE_"
...
@lru_cache()
def get_settings() -> ProductionPaymentServiceConfig:
    """
    ...
    """
    return ProductionPaymentServiceConfig()
