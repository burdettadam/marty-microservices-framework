...
class ServiceGenerator:
    ...
    def generate_service(self, service_type: str, service_name: str, **options: Any) -> None:
        ...
        if service_type == "fastapi":
            template_subdir = "fastapi/fastapi-service"
        elif service_type == "simple-fastapi":
            template_subdir = "fastapi/simple-fastapi-service"
        elif service_type == "grpc":
            template_subdir = "grpc/grpc_service"
        elif service_type == "hybrid":
            template_subdir = "hybrid/hybrid_service"
        elif service_type == "minimal":
            template_subdir = "shared/config-service"  # Use config-service as minimal template
        else:
