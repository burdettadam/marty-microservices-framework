...
def main():
    ...
    content_ok &= check_content("enums.py", [
    ...
    print("\n📋 Checking config.py...")
    content_ok &= check_content("config.py", [
    ...
    print("\n📋 Checking base.py...")
    content_ok &= check_content("base.py", [
    ...
    content_ok &= check_content("transformation.py", [
    ...
    content_ok &= check_content("connectors/rest_api.py", [
    ...
    if files_ok and content_ok:
        ...
        print("   • enums.py: 4 enums (ConnectorType, DataFormat, IntegrationPattern, TransformationType)")
