...
from mmf.examples.service_templates.fastapi_example.application.service import (
    OrderService,
)
from mmf.examples.service_templates.fastapi_example.domain.models import (
    Order,
    OrderItem,
)
from mmf.examples.service_templates.fastapi_example.infrastructure.adapters import (
