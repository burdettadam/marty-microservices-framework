...
from mmf.examples.service_templates.hybrid_example.domain.ports import (
...
class OrderService:
    ...
    async def get_orders_batch(self, order_ids: list[str]) -> list[Order]:
        """Get multiple orders by IDs."""
        return await self.repo.get_by_ids(order_ids)
