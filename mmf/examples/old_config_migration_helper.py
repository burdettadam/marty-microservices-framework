...
from mmf.framework.infrastructure.config import load_service_configuration
...
def load_old_config_from_boneyard(environment: str = "development") -> dict:
    ...
    Note:
        This is only for migration purposes. Use mmf.framework.infrastructure.config
...
def main():
    ...
    print("from mmf.framework.infrastructure.config import load_service_configuration")
