...
from mmf.core.application.database import DatabaseConfig
from mmf.framework.infrastructure.config import MMFConfiguration
from mmf.services.identity.infrastructure.adapters.config_integration import (
...
def demo_configuration_migration():
    ...
    try:
        ...
        config_path = Path.cwd() / "mmf" / "config"
