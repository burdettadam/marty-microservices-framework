...
class TestFrameworkConfig:
    ...
    def test_config_creation_with_defaults(self):
        ...
        config = BaseServiceConfig(
            ...
            secret_key="default-secret",  # pragma: allowlist secret
        )
    ...
    def test_config_from_dict(self):
        ...
        config_dict = {
            ...
            "port": 8443,
            "database_url": "sqlite:///:memory:",
            "secret_key": "dict-secret",  # pragma: allowlist secret
        }
    ...
    def test_config_from_dict_partial(self):
        ...
        config_dict = {
            ...
            "debug": True,
            "database_url": "sqlite:///:memory:",
            "secret_key": "partial-secret",  # pragma: allowlist secret
        }
    ...
    def test_config_validation_valid(self):
        ...
        FrameworkConfig(
            ...
            port=8080,
            database_url="sqlite:///:memory:",
            secret_key="valid-secret",  # pragma: allowlist secret
        )
    ...
    def test_config_to_dict(self):
        ...
        config = FrameworkConfig(
            ...
            port=9000,
            database_url="sqlite:///:memory:",
            secret_key="serialize-secret",  # pragma: allowlist secret
        )
    ...
    def test_config_update(self):
        ...
        config = FrameworkConfig(
            ...
            database_url="sqlite:///:memory:",
            secret_key="original-secret",  # pragma: allowlist secret
        )
