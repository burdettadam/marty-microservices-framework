...
from mmf.services.identity.application.ports_out import UserRepository
from mmf.services.identity.domain.models import AuthenticatedUser, Credentials, UserId
