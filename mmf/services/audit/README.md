...
`src/marty_msf/framework/audit/` to `mmf/services/audit/` using hexagonal
...
```python
from mmf.services.audit import (
    AuditService,
    create_audit_service,
    create_default_audit_config,
    LogRequestCommand,
)
from mmf.core.domain.audit_types import AuditEventType, AuditSeverity, AuditOutcome
...
```python
from mmf.services.audit import audit_context
...
```python
from mmf.services.audit import QueryAuditEventsCommand
...
```python
from mmf.services.audit import GenerateAuditReportCommand
...
[See `mmf/core/domain/audit_types.py` for complete list]
...
### New API (mmf/services/audit)

```python
from mmf.services.audit import audit_context, LogRequestCommand
