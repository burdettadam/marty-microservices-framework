...
from mmf.framework.testing.infrastructure.database import TestDatabaseManager
from mmf.framework.testing.infrastructure.events import TestEventCollector
...
class AsyncTestCase:
    ...
    async def setup_async_test(self):
        ...
        logging.getLogger("mmf").setLevel(logging.WARNING)
