"""
Core Messaging Interfaces and Models.

This module defines the standard interfaces and models for the messaging system.
It is the single source of truth for messaging contracts in the Marty Microservices Framework.
"""
