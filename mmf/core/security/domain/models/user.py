"""
User and Principal Domain Models

This module defines the core domain models for users and security principals.
It consolidates the legacy User/AuthenticatedUser models with the new identity service models.
"""
