...
pub enum SessionState {
    ...
    Terminated,
    Suspended,
    /// Compatibility state for the first Rust session surface.
    Invalid,
}
...
fn reason_name(reason: SessionEventType) -> &'static str {
    match reason {
        ...
        SessionEventType::SessionAccessed => "session_accessed",
        SessionEventType::SessionExtended => "session_extended",
        SessionEventType::SessionExpired => "session_expired",
        SessionEventType::SessionInvalidated => "session_invalidated",
        SessionEventType::SessionTerminated => "session_terminated",
        SessionEventType::SessionRotated => "session_rotated",
        SessionEventType::IpAddressChanged => "ip_address_changed",
        SessionEventType::UserAgentChanged => "user_agent_changed",
        SessionEventType::ConcurrentSessionDetected => "concurrent_session_detected",
        SessionEventType::SuspiciousActivity => "suspicious_activity",
        SessionEventType::AuthenticationSuccess => "authentication_success",
        SessionEventType::AuthenticationFailure => "authentication_failure",
        SessionEventType::MfaCompleted => "mfa_completed",
        SessionEventType::PrivilegeEscalation => "privilege_escalation",
        SessionEventType::RoleChanged => "role_changed",
        SessionEventType::SessionDataUpdated => "session_data_updated",
        SessionEventType::SessionDataCleared => "session_data_cleared",
        SessionEventType::AdminSessionView => "admin_session_view",
        SessionEventType::AdminSessionTerminate => "admin_session_terminate",
        SessionEventType::SessionCleanup => "session_cleanup",
