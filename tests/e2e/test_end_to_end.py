...
class TestEndToEnd:
    ...
    async def test_event_driven_workflow(
        ...
        real_event_bus.register_handler(
            name="track-user-created",
            event_type="user.created",
            handler_func=track_user_created
        )
    ...
    async def test_performance_benchmarks(
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                ...
                assert avg_response_time < 0.2  # Average under 200ms (realistic for Docker test environment)
