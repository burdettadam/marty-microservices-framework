...
def security_test_credentials():
    ...
    return {
        "valid_user": {"username": "security_test_user", "password": "SecureTestPass123!"},
...
def rate_limiting_config():
    ...
    return {
        ...
        "test_endpoints": ["/authenticate", "/users", "/health"],
    }
...
def penetration_test_vectors():
    ...
    return {
        ...
        "ldap_injection": ["*)(uid=*", "*)(|(uid=*))", "*)(&(uid=*))", "*)(!(&(uid=*)))"],
        "nosql_injection": [
            '{"$ne": ""}',
            '{"$gt": ""}',
            '{"$regex": ".*"}',
...
def vulnerability_scanner():
    ...
    return {"scan_headers": scan_headers, "scan_authentication": scan_authentication}
...
def crypto_test_utils():
    ...
    def check_password_strength(password: str) -> dict[str, Any]:
        ...
        return {
            ...
            "strength": strength,
            "checks": checks,
            "recommendations": [key for key, passed in checks.items() if not passed],
        }
