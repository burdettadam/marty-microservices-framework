...
config = DatabaseConfig(
    ...
    database_url="postgresql+asyncpg://user:pass@localhost/userdb",
    pool_size=5,
    max_overflow=10,
    echo=False
)
...
# After (new framework)
from mmf_new.core.domain.entity import Entity
...
```python
from mmf_new.core.application.base import UseCase
