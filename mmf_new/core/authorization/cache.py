...
Wraps the mmf_new.infrastructure.cache.CacheManager with authorization-specific helpers.
...
from mmf_new.infrastructure.cache import CacheBackend, CacheConfig, CacheManager
