...
from .rbac import RoleManager, get_role_manager
...
class RoleBasedAuthorizer(IAuthorizer):
    ...
    def __init__(self, role_manager: RoleManager | None = None):
        ...
        Args:
            role_manager: Optional RoleManager instance. If None, uses global manager.
        """
...
def create_role_based_authorizer(
    ...
    Args:
        role_manager: Optional RoleManager instance
