...
from marty_msf.security_core.api import User
from marty_msf.security_core.canonical import (
...
from .di_container import get_service, has_service, register_instance
...
class SecurityContext:
    ...
    def permissions(self) -> set[str]:
        """
        Get user permissions from the authorization bootstrap.
...
def verify_jwt_token(token: str) -> User | None:
    ...
    Example:
        user = verify_jwt_token("eyJhbGciOiJIUzI1...")
        if user:
