...
# Re-export core authorization interfaces from security_core
# Note: security_core hasn't been migrated yet, so we import from old location
from marty_msf.security_core.api import (
    AuthorizationContext,
    AuthorizationResult,
    IAuthorizer,
)
from marty_msf.security_core.api import PermissionAction as SecurityCorePermissionAction
from marty_msf.security_core.api import (
    User,
)
...
class PermissionAction(Enum):
    ...
    @classmethod
    def from_security_core(cls, action: SecurityCorePermissionAction) -> PermissionAction:
        """Convert from security_core PermissionAction."""
        mapping = {
            SecurityCorePermissionAction.CREATE: cls.CREATE,
            SecurityCorePermissionAction.READ: cls.READ,
            SecurityCorePermissionAction.UPDATE: cls.UPDATE,
            SecurityCorePermissionAction.DELETE: cls.DELETE,
            SecurityCorePermissionAction.EXECUTE: cls.EXECUTE,
        }
        return mapping.get(action, cls.ALL)
