...
from mmf_new.examples.service_templates.fastapi_example.domain.models import Order, OrderItem
from mmf_new.examples.service_templates.fastapi_example.application.service import OrderService
