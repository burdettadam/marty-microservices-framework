...
from mmf_new.examples.service_templates.grpc_example.domain.models import Order, OrderItem
from mmf_new.examples.service_templates.grpc_example.application.service import OrderService
from mmf_new.examples.service_templates.grpc_example.infrastructure.adapters import (
...
async def serve():
    ...
    try:
        ...
        service_impl = OrderServiceImpl(order_service, inventory_adapter)
