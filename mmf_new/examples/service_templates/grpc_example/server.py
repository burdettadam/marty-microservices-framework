...
from mmf_new.examples.service_templates.grpc_example.application.service import (
    OrderService,
)
from mmf_new.examples.service_templates.grpc_example.domain.models import (
    Order,
    OrderItem,
)
