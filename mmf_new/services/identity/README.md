...
pytest mmf_new/services/identity/tests/test_domain_models.py      # Domain unit tests
pytest mmf_new/services/identity/tests/test_authentication_usecases.py  # Use case tests
pytest mmf_new/services/identity/tests/test_integration.py       # Integration tests
```
