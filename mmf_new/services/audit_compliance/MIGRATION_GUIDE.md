...
module to the new hexagonal architecture implementation in `mmf_new`. The
...
```text
mmf_new/services/audit_compliance/
...
- **Repository Pattern**: Extends `Repository[T]` from mmf_new core
...
```python
from mmf_new.services.audit_compliance.service_factory import (
...
pytest mmf_new/services/audit_compliance/tests/integration/ -v

# Run specific test categories
pytest mmf_new/services/audit_compliance/tests/integration/test_audit_compliance_integration.py::TestAuditEventOperations -v

# Run performance tests
pytest mmf_new/services/audit_compliance/tests/integration/test_audit_compliance_integration.py::TestPerformanceAndScalability -v
```text
...
from mmf_new.services.audit_compliance.tests.integration.conftest import validate_test_environment
...
5. **Framework Integration**: Seamless integration with mmf_new core services
